...
class Students extends React.Component {
    ...
    delete = (studentId) => {
        axios.delete("https://dmapi.eu-west-3.elasticbeanstalk.com/admin/student/" + studentId, { headers: { "Authorization": `Bearer ${token}` } })
            .then(response => {
                ...
                <div id="page-content-wrapper">
                    ...
                    <div className="container-fluid px-4">
                        ...
                        <div className="row my-5">
                            ...
                            {isAddUserFormOpen &&
                                <AdminAddStudent isOpen={isAddUserFormOpen}
